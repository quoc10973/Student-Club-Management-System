...
namespace ClubManagementSystem.Repository.Basic
{
    public class GenericRepository<T> where T : class
    {
        protected ClubManagementSystemContext _context;

        public GenericRepository(ClubManagementSystemContext context)
        {
            _context = context;
        }
